...
For users of the Go plugin APIs the import path of this module needs to be updated to `github.com/ivan-zherdev/benthos/v4`, like so:
...
[plugins.docs]: https://pkg.go.dev/github.com/ivan-zherdev/benthos/v4/public
