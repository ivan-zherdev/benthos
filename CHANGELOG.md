...
- Go API: Module name has changed to `github.com/ivan-zherdev/benthos/v4`.
- Go API: All packages within the `lib` directory have been removed in favour of the newer [APIs within `public`](https://pkg.go.dev/github.com/ivan-zherdev/benthos/v4/public).
