...
VER_FLAGS = -X github.com/ivan-zherdev/benthos/v4/internal/cli.Version=$(VERSION) \
	-X github.com/ivan-zherdev/benthos/v4/internal/cli.DateBuilt=$(DATE)
...
fmt:
	...
	@go list -f {{.Dir}} ./... | xargs -I{} goimports -w -local github.com/ivan-zherdev/benthos/v4 {}
	@go mod tidy
